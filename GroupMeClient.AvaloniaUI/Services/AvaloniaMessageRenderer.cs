...
{
    public class AvaloniaMessageRenderer : IMessageRendererService
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AvaloniaMessageRenderer"/> class.
        /// </summary>
        /// <param name="cacheManager">The cache instance to use.</param>
        public AvaloniaMessageRenderer(CacheManager cacheManager)
        {
